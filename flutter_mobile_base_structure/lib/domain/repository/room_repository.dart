...
abstract class RoomRepository {
  ...
  Future<Room> editOfficerFromRoom(
      {int roomIndex, int index, String name, String gender});

  Future<List<Room>> changeOfficerToRoom({String roomChoice, Officer officer});
  Future<Room> setPhoPhong({int roomIndex, int officerIndex, bool isSelected});
  Future<Room> setTruongPhong({int roomIndex, int officerIndex});
}
